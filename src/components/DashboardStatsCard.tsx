...
export default function DashboardStatsCard({ title, value, description, icon: Icon, theme }: StatsCardProps) {
  ...
  return (
    <div className={`group bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200/60 dark:border-slate-800/80 shadow-xs flex items-center ${selectedTheme.hover} transition-all duration-300 ease-in-out hover:shadow-lg hover:-translate-y-1 cursor-pointer`}>
